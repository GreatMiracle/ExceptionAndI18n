...
public class ObjectMapperUtils {
    ...
    public static <T, D> T mapDtoToEntity(final D dto, Class<T> outClass) {
        return modelMapper.map(dto, outClass);
    }

    public static <D, T> D mapEntityToDto(final T dto, Class<D> outClass) {
        return modelMapper.map(dto, outClass);
    }
    ...
    public static <D, T> List<D> mapListEntityToDto(List<T> entities, Class<D> dtoClass) {
